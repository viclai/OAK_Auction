...
public class AuctionSearchClient
{
                                           ...
                                           int numResultsToReturn)
  {
    try
    {
      ...
      Object[] reply = rpcClient.invokeBlocking(
        basicSearchOp, parameters, returnTypes
      );
                                             ...
                                             int numResultsToReturn)
  {
    try
    {
      ...
      Object[] parameters = new Object[] {
        query, region, new Integer(numResultsToSkip),
        new Integer(numResultsToReturn)
      };
      Class[] returnTypes = new Class[] { SearchResult[].class };
      Object[] reply = rpcClient.invokeBlocking(
        spatialSearchOp, parameters, returnTypes
      );
      return (SearchResult[])reply[0];
    }
    catch (AxisFault e)
  ...
  public static String getXMLDataForItemId(String itemId)
  {
    try
    {
      ...
      Object[] reply = rpcClient.invokeBlocking(
        getXmlOp, parameters, returnTypes
      );
